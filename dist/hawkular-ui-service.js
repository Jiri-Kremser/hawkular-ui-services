...
var hawkRest_1 = require('./hawkRest');
hawkRest_1._module.provider('HawkularOps', function () {
    var _this = this;
...
hawkRest_1._module.constant('inventoryInterceptURLS', [new RegExp('.+/inventory/.+/resources/.+%2F.+', 'i'), new RegExp('.+/inventory/.+/resources/.+%252F.+', 'i')]);
hawkRest_1._module.config(['$httpProvider', 'inventoryInterceptURLS', function ($httpProvider, inventoryInterceptURLS) {
        var SLASH = '/';
...
hawkRest_1._module.provider('HawkularInventory', function () {
    ...
    this.$get = ['$resource', '$location', '$rootScope', '$log',
        function ($resource, $location, $rootScope, $log) {
            ...
            factory.MetricTypeOfResourceType = $resource(metricTypeOfResourceTypeUrl);
            var feedMetricTypeOfResourceTypeUrl = url + '/feeds/:feedId/resourceTypes/:resourceTypeId/metricTypes/:metricTypeId';
            factory.MetricTypeOfResourceTypeUnderFeed = $resource(feedMetricTypeOfResourceTypeUrl);
            ...
            factory.RxEvents = function (tenantId) {
                var subject = Rx.Observable.webSocket(wsUrl + ("?tenantId=" + tenantId));
                return subject;
            };
            return factory;
        }];
...
var _module = angular.module('hawkular.services', ['ngResource']);
exports._module = _module;

var hawkRest_1 = require('./hawkRest');
hawkRest_1._module.provider('HawkularAccount', function () {
    this.setProtocol = function (protocol) {
        this.protocol = protocol;
        return this;
    };
...
var hawkRest_1 = require('./hawkRest');
hawkRest_1._module.provider('HawkularAlert', function () {
    this.setProtocol = function (protocol) {
        this.protocol = protocol;
        return this;
    };
...
var hawkRest_1 = require('./hawkRest');
hawkRest_1._module.provider('HawkularMetric', function () {
    this.setProtocol = function (protocol) {
        this.protocol = protocol;
        return this;
    };
